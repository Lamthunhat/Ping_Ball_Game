...
public class GameWindow extends JFrame {
    ...
    private void showInstructions() {
        ...
        JLabel instructionsLabel = new JLabel(
                "<html><p style='color:white; font-size:18px*scaleX;margin:8px'>Use arrow keys to move the paddle to the left or right.<br>Keep the ball not falling and reach the goal!</p></html>");
    ...
    private void showInfo() {
        ...
        JLabel infoLabel = new JLabel(
                "<html><p style='color:white; font-size:18px*scaleX;'>Don't Drop It Adventure<br>Version 1.0<br>Developed by TuLaLiTeam!</p></html>");
